...
Check [`defaults/main.yml`](defaults/main.yml) for the full list of supported options. Refer to [this page](docs/configuring-syncstorage-rs-docker.md) for details about setting up the service with this role.
