...
See the project's [documentation](https://github.com/mozilla-services/syncstorage-rs/blob/master/README.md) to learn what syncstorage-rs does and [*syncstorage-rs-docker*](https://github.com/dan-r/syncstorage-rs-docker)'s documentation about how to set it up.
